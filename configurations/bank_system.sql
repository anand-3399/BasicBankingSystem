...
--
-- Database: `bank`
-- For Xampp Server Uncomment below two comments 

-- CREATE DATABASE bank_system;
-- USE bank_system; 

-- --------------------------------------------------------
-- // For 00webhsotapp use your database name instead of bank_system

USE id19579538_anand; 
--
...
(1, 'Anand Jaiswar', 'anandjaiswar02@gmail.com', 689500),
(2, 'Aman Jaiswal', 'amanjais160@gmail.com', 28000),
...
(1, 'Anand Jaiswar', 'Manya Yadav', 700),
(2, 'Sanket Batra', 'Priya Wagh', 1200),
(3, 'Iswarya Verma', 'Anand Jaiswar', 2300),
(4, 'Pranjal Aggrawal', 'Aman Jaiswal', 650),
(5, 'Manya Yadav', 'Aaron James', 2100),
(6, 'Anjana Sharma', 'Sanket Batra', 3000),
(7, 'Anand Jaiswar', 'Ishita Rao', 12000),
